...
public class Scanner {
	...
	static {
		...
		literals.put("class", new Integer(5));
		literals.put("extends", new Integer(6));
		literals.put("implements", new Integer(8));
		literals.put("interface", new Integer(11));
		literals.put("void", new Integer(15));
		literals.put("to", new Integer(19));
		literals.put("title", new Integer(20));
		literals.put("public", new Integer(21));
		literals.put("protected", new Integer(22));
		literals.put("private", new Integer(23));
		literals.put("static", new Integer(24));
		literals.put("association", new Integer(25));
		literals.put("dassociation", new Integer(26));
		literals.put("aggregation", new Integer(27));
		literals.put("daggregation", new Integer(28));
		literals.put("composition", new Integer(29));
		literals.put("dcomposition", new Integer(30));
		literals.put("dependency", new Integer(31));
		literals.put("ddependency", new Integer(32));
